...
describe('Lambda Handler', () => {
    ...
    it('should return 200 and success message on successful upload', async () => {
        ...
        expect(JSON.parse(result.body).message).toBe('File uploaded and email sent successfully');
    });
    ...
    it('should return 500 and error message on email send error', async () => {
        ...
        jest.spyOn(EmailService, 'sendEmailNotification').mockRejectedValue(mockError);
